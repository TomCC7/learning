...
{
    using namespace cv;
    std::vector<uint> src = get_brightness_data(src_img);
...
std::vector<uint> get_brightness_data(const cv::Mat &src)
{
    using namespace cv;
    Mat src_gray;
    // check image
